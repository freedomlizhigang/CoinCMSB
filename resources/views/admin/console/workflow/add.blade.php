<form action="javascript:ajax_submit();" method="post" id="form_ajax">
	...
	<table class="table table-striped">
        <tr>
            ...
            <td>
                <input type="text" name="data[workname]" class="form-control input-sm" value="{{ old('data.workname') }}">
        ...
        <tr>
            ...
            <td>
                <textarea name="data[description]" class="form-control" rows="5">{{ old('data.description') }}</textarea>
	...
	<div class="modal-footer">
        ...
        <div onclick='ajax_submit_form("form_ajax","{{ url('/console/workflow/add') }}")' name="dosubmit" class="btn btn-info">提交</div>
    </div>
</form>
<script>
    $(function(){
