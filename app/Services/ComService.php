...
{
    // 增加点击量
    public function addHit($cate_id = 0,$art_id = 0,$ip = '00:00:00:00')
    {
        // 点击量增加
        $date = getdate();
        Hit::create(['cate_id'=>$cate_id,'art_id'=>$art_id,'year'=>$date['year'],'month'=>$date['mon'],'day'=>$date['mday'],'hour'=>$date['hours'],'minute'=>$date['minutes'],'ip'=>$ip]);
    }
    // 判断是不是移动端
